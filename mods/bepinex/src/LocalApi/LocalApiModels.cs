...
internal sealed class RecommendationStateSnapshot
{
    ...
    public List<RuntimeSpecialRuleContext> SpecialRules { get; init; } = new();
    public string SpecialRuleStatus { get; init; } = "";
    ...
    public static RecommendationStateSnapshot From(RecommendationState state)
    {
        return new RecommendationStateSnapshot
        {
            ...
            SpecialRules = state.SpecialRules.ToList(),
            SpecialRuleStatus = state.SpecialRuleStatus,
        };
    }
}
